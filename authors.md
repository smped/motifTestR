...
- **[Stevie Pederson](https://github.com/smped)**. Author, maintainer.
...
Pederson S (2026). *motifTestR: Perform key tests for binding motifs in
sequence data*. R package version 1.7.2,
