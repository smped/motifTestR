...
#>      [1]     chr1         18965-19364      * |         1
#>      [2]     chr1       191267-191666      * |         1
#>      [3]     chr1       257280-257679      * |         2
#>      [4]     chr1       550267-550666      * |         1
#>      [5]     chr1       681627-682026      * |         2
#>      ...      ...                 ...    ... .       ...
#>   [1694]     chr1 248507085-248507484      * |         2
#>   [1695]     chr1 248666042-248666441      * |         1
#>   [1696]     chr1 248674153-248674552      * |         2
#>   [1697]     chr1 249138117-249138516      * |         2
#>   [1698]     chr1 249212159-249212558      * |         1
#>   -------
...
#>            <Rle>           <IRanges>  <Rle>
#>     [1]     chr1     6204139-6204538      *
#>     [2]     chr1     8926298-8926697      *
#>     [3]     chr1   10338571-10338970      *
#>     [4]     chr1   11417646-11418045      *
#>     [5]     chr1   16337076-16337475      *
#>     ...      ...                 ...    ...
#>    [96]     chr1 230665210-230665609      *
#>    [97]     chr1 230912871-230913270      *
#>    [98]     chr1 233367732-233368131      *
#>    [99]     chr1 243568836-243569235      *
#>   [100]     chr1 245708450-245708849      *
#>   -------
#>   seqinfo: 24 sequences from hg19 genome
